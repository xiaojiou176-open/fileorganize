---
title: Movi | Review-first file organization docs
description: Review-first docs for Movi, the local-first file organizer and workbench with AI-assisted planning, dry-run execution, rollback-ready recovery, and an agent-safe MCP v1 surface.
---

Movi is a review-first local file organizer and workbench for messy photos, screenshots, documents, and audio. It lets AI assist with manifest drafting first, then lets you review the plan before deterministic `apply` or `rollback` touches your files.

![Movi overview showing mixed files flowing into manifest review and organized output](./assets/storefront/hero-movi-overview.svg)
...
- **AI-assisted**: Movi helps propose labels, rules, and review inputs without claiming autonomous file organization.
...
- **Agent-safe extension surface**: Movi MCP v1 exposes the same review-safe workflow to agents without adding a hidden “move files now” shortcut.
...
| If you want... | Open... |
| :-- | :-- |
| a Codex-friendly MCP route | [Movi MCP For Codex](./codex_mcp.md) |
| a Claude Code-friendly MCP route | [Movi MCP For Claude Code](./claude_code_mcp.md) |
| the generic Movi MCP contract | [Movi MCP v1](./mcp.md) |
...
- [Movi MCP For Claude Code](./claude_code_mcp.md)
