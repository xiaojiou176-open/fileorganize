...
> **Movi is a review-first local file organizer and workbench with AI-assisted planning, dry-run execution, and rollback-ready recovery.**
...
| `docs/review_first_ai_file_organizer.md` | high-intent landing page for people comparing Movi against zero-review AI organizers |
...
| :-- | :-- | :-- |
| `Movi Review` | explain review queue, triage, and human approval flow | current surface name, future dedicated landing |
| `Movi Rules` | explain reusable rules and rule drafting | current surface name, future dedicated landing |
| `Movi Inbox` | explain intake/watch-source workflow | current surface name, future dedicated landing |
| `Movi Copilot` | explain review-only AI guidance, batch triage, and draft generation | current review-only surface |
| `Movi MCP` | explain deeper agent workflows or future broader integration layers beyond v1 | current v1 exists; broader surface can expand later |
...
- Treat `Movi MCP v1` as a current extension surface, but not as the main headline that replaces the core review-first story.
