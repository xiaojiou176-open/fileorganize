...
- it suggests reusable rules
- it helps route you back to the right problems

But it still keeps real file execution behind:

- review-first approval
- overlay-only edits
- dry-run before execute
- rollback-ready recovery

Think of it like packing for a trip. AI can help build the packing list and group items into bags, but the actual loading still happens from an approved checklist instead of a robot throwing everything into the trunk.
...
- receipts
- chat exports
- mixed folders of documents and media

It is especially useful if you want:

- local-first operation
- a review queue before changes happen
- a manifest or paper trail
- safer undo and auditability
...
- a cloud-first storage product
- an agent that silently changes files behind the scenes
