...
describe('AnalyzePage', () => {
  it('loads inbox handoff context and strategy-pack explanation', async () => {
    ...
    expect(await screen.findByText('Handoff from Movi Inbox')).toBeInTheDocument()
    ...
    expect(screen.getByText(/the pack shapes how Movi drafts the first pass/i)).toBeInTheDocument()
  })
