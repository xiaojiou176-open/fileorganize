...
- clears workspace .movi state via tooling/runtime/reset_workspace_state.sh
...
if [ "${1:-}" != "--confirm-workspace-reset" ] || [ "$#" -ne 1 ]; then
  ...
  echo "This command will clear workspace .movi state via tooling/runtime/reset_workspace_state.sh." >&2
