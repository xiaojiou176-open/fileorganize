...
DEFAULT_ASSETS = (
    "docs/assets/storefront/hero-movi-overview.svg",
    "docs/assets/storefront/ten-second-tour-movi.svg",
    "docs/assets/storefront/before-after-movi.svg",
    "docs/assets/storefront/social-preview-movi.svg",
)
...
def main() -> int:
    ...
    if args.out_dir:
        ...
        out_dir = Path(tempfile.mkdtemp(prefix="movi-storefront-assets-"))
